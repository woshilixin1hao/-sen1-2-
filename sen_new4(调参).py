...
def diffusion_loss_with_color(model, scheduler, x0, cond, device):
    ...
    base_lambda_color = 0.1 # 色彩损失基础权重，0.1 是个比较稳妥的起点
...
def parse_args():
    ...
    p.add_argument("--log_dir", type=str, default="./logs_new4_1")
    p.add_argument("--model_dir", type=str, default="./models_new4_1")
    p.add_argument("--sample_dir", type=str, default="./samples_new4_1")
    p.add_argument("--resume", type=str, default="./models_new4/ckpt_159_608000.pt", help="如果需要从某个检查点恢复训练，请提供该检查点的路径")
    p.add_argument("--cuda", type=str, default="cuda:3")
